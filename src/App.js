        ...
        return (
            <ThemeProvider theme={theme}>
                ...
                <Box sx={{
                    ...
                    {(!this.state.isProfile) ? <Leaderboard isDark={this.state.isDark} userSelect = {this.userSelectCallback} /> : <Profile userID={this.state.selectedID} isDark={this.state.isDark} userSelect = {this.userSelectCallback} />}
                </Box>
                </Box>
            </ThemeProvider>
        );
